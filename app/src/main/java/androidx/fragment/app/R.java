...
public abstract class R {
    ...
    ArrayList<String> a(ArrayList<View> arrayList) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            arrayList2.add(b.d.g.v.e(view));
            b.d.g.v.a(view, (String) null);
        }
        return arrayList2;
    }
    ...
    void a(View view, ArrayList<View> arrayList, ArrayList<View> arrayList2, ArrayList<String> arrayList3, Map<String, String> map) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            String strE = b.d.g.v.e(view2);
            arrayList4.add(strE);
            if (strE != null) {
                b.d.g.v.a(view2, (String) null);
                ...
                while (true) {
                    ...
                    if (str.equals(arrayList3.get(i3))) {
                        b.d.g.v.a(arrayList2.get(i3), strE);
                        break;
                    }
                    i3++;
                }
        ...
        b.d.g.p.a(view, new O(this, size, arrayList2, arrayList3, arrayList, arrayList4));
    }
    ...
    void a(View view, ArrayList<View> arrayList, Map<String, String> map) {
        b.d.g.p.a(view, new P(this, arrayList, map));
    }

    void a(ViewGroup viewGroup, ArrayList<View> arrayList, Map<String, String> map) {
        b.d.g.p.a(viewGroup, new Q(this, arrayList, map));
    }
