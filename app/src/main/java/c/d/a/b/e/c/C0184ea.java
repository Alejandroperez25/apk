...
/* renamed from: c.d.a.b.e.c.ea, reason: case insensitive filesystem */
/* loaded from: classes.dex */
public final class C0184ea implements Parcelable.Creator<C0186fa> {
    @Override // android.os.Parcelable.Creator
    public final /* synthetic */ C0186fa[] newArray(int i2) {
        return new C0186fa[i2];
    }

    @Override // android.os.Parcelable.Creator
    public final /* synthetic */ C0186fa createFromParcel(Parcel parcel) {
