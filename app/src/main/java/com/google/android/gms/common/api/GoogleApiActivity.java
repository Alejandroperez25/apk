...
public class GoogleApiActivity extends Activity implements DialogInterface.OnCancelListener {
    ...
    protected void onCreate(Bundle bundle) throws IntentSender.SendIntentException {
        ...
        if (bundle != null) {
            this.f4838a = bundle.getInt("resolution");
        }
        if (this.f4838a != 1) {
            ...
            if (pendingIntent == null && num == null) {
                ...
                c.d.a.b.b.d.b().b(this, num.intValue(), 2, this);
                this.f4838a = 1;
            }
        }
    }
    ...
    protected void onActivityResult(int i2, int i3, Intent intent) {
        ...
        if (i2 == 1) {
            ...
            setResult(i3, intent);
            if (booleanExtra) {
                C0323c c0323cA = C0323c.a(this);
                switch (i3) {
                    case -1:
                        c0323cA.d();
                        break;
                    case 0:
                        c0323cA.b(new c.d.a.b.b.a(13, null), getIntent().getIntExtra("failing_client_id", -1));
                        break;
                }
            }
        } else if (i2 == 2) {
    ...
    protected void onSaveInstanceState(Bundle bundle) {
        bundle.putInt("resolution", this.f4838a);
