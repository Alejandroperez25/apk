...
public final class Q implements Parcelable.Creator<C0354a> {
    @Override // android.os.Parcelable.Creator
    public final /* synthetic */ C0354a[] newArray(int i2) {
        return new C0354a[i2];
    }

    @Override // android.os.Parcelable.Creator
    public final /* synthetic */ C0354a createFromParcel(Parcel parcel) {
        ...
        return new C0354a(strI, strI2, strI3, strI4, zC, strI5, zC2, strI6, iE, strI7);
    }
}
