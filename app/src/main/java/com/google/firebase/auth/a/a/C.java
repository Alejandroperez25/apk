...
final class C extends Ka<InterfaceC0404d, InterfaceC0412c> {
    private final C0208qa z;

    public C(AbstractC0403c abstractC0403c, String str) {
        super(2);
    ...
    public final AbstractC0329j<xa, InterfaceC0404d> c() {
        ...
        aVarA.a(new InterfaceC0327h(this) { // from class: com.google.firebase.auth.a.a.B
            ...
            public final void accept(Object obj, Object obj2) {
                this.f5237a.a((xa) obj, (c.d.a.b.h.i) obj2);
            }
        });
        return aVarA.a();
    }
    ...
    public final void d() {
        ...
        if (this.f5250d.i().equalsIgnoreCase(eA.i())) {
            ...
            b((C) new com.google.firebase.auth.internal.y(eA));
        } else {
            a(new Status(17024));
        }
    }
