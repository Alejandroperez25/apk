...
public final class fa implements Parcelable.Creator<C0442x> {
    @Override // android.os.Parcelable.Creator
    public final /* synthetic */ C0442x[] newArray(int i2) {
        return new C0442x[i2];
    }

    @Override // android.os.Parcelable.Creator
    public final /* synthetic */ C0442x createFromParcel(Parcel parcel) {
