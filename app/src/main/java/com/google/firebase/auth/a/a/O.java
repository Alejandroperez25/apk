...
final class O extends Ka<InterfaceC0404d, InterfaceC0412c> {
    private final C0224ya z;

    public O(com.google.firebase.auth.A a2, String str) {
        super(2);
    ...
    public final AbstractC0329j<xa, InterfaceC0404d> c() {
        ...
        aVarA.a(new InterfaceC0327h(this) { // from class: com.google.firebase.auth.a.a.N
            ...
            public final void accept(Object obj, Object obj2) {
                this.f5260a.a((xa) obj, (c.d.a.b.h.i) obj2);
            }
        });
        return aVarA.a();
    }
    ...
    public final void d() {
        ...
        if (this.f5250d.i().equalsIgnoreCase(eA.i())) {
            ...
            b((O) new com.google.firebase.auth.internal.y(eA));
        } else {
            a(new Status(17024));
        }
    }
